...
public class Client {
	...
	public static void main(String[] args) 
	{
		...
		Object obj=s.getNewSavingAcc(11, "Netrangi", 14000, false);
		 System.out.println(obj);
		// SavingAcc n=new MMSavingAcc(101, "Ranjana", 10000f, true);
		// CurrentAcc c1= new MMCurrentAcc(102,"Anurag", 10000, 20000);
